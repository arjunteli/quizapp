...
//	}
	...
	public String toString() {
		return "Question [id=" + id + ", QuestionTitle=" + QuestionTitle + ", option1=" + option1 + ", option2="
				...
				+ ", category=" + category + ", difficultyLevel=" + difficultyLevel + ", getDifficultyLevel()="
				+ getDifficultyLevel() + ", getId()=" + getId() + ", getQuestionTitle()=" + getQuestionTitle()
				+ ", getOption1()=" + getOption1() + ", getOption2()=" + getOption2() + ", getOption3()=" + getOption3()
				+ ", getOption4()=" + getOption4() + ", getRightAnswer()=" + getRightAnswer() + ", getCategory()="
